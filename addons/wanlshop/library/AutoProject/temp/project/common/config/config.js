...
export default {
	...
	socketurl: 'wss://im.manyajp.com', //如果是ws:// 地址为ws://你服务器IP:7272 如 ws://123.4.56.78:7272，使用wss 后面不需要添加 :7272 端口

	cdnurl: 'https://api.manyajp.com/',

	appurl: 'https://api.manyajp.com/api', //如二级域名：https://api.wanlshop.com 或不使用二级域名 https://www.wanlshop.com/api
