<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/console/index.html";i:1654875681;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1654875636;}*/ ?>
<!DOCTYPE html>
                                ...
                                <div class="row row-sm stats-container">
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> <?php echo __('Add a shopping cart'); ?></div>
                                        </div>
                                        <div class="progress">
                                    ...
                                    <div class="col-xs-6 stat-col">
                                        ...
                                        <div class="stat">
                                            ...
                                            <div class="name"> <?php echo __('Total'); ?></div>
                                        </div>
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-success" style="width: 25%"></div>
                                        </div>
