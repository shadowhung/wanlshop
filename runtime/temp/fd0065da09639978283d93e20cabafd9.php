<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/comment/detail.html";i:1654745638;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										...
										<div class="content">
											...
											<style type="text/css">	.star-rating {	    color: #ddd;	    font-size: 0;		display: table;	    position: relative;	}	.star-rating i {		padding: 5px;		padding-left: 0;		font-size: 16px;	}	.star-rating-top {		color: #f72b36;		padding: 0;		position: absolute;		z-index: 1;		display: block;		top: 0;		left: 0;		overflow: hidden;		white-space: nowrap;	}	.star-rating-bottom {		padding: 0;		display: block;		z-index: 0;	}</style><p><i class="fa fa-gift"></i> 製品詳細</p><table class="table table-bordered">	<thead>		<tr>			<th class="text-center">				<div class="th-inner">商品コード</div>			</th>			<th class="text-center">				<div class="th-inner">メイン画像</div>			</th>			<th class="text-center">				<div class="th-inner">商品名</div>			</th>			<th class="text-center">				<div class="th-inner">コメントの総数</div>			</th>			<th class="text-center">				<div class="th-inner">賞賛</div>			</th>			<th class="text-center">				<div class="th-inner">平均</div>			</th>			<th class="text-center">				<div class="th-inner">悪いレビュー</div>			</th>			<th class="text-center">				<div class="th-inner">コレクションの数</div>			</th>			<th class="text-center">				<div class="th-inner">支払い回数</div>			</th>			<th class="text-center">				<div class="th-inner">オペレーティング</div>			</th>		</tr>	</thead>	<tbody>		<tr>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['id']; ?></td>			<td><a href="<?php echo $row['goods']['image']; ?>" target="_blank"><img class="img-sm img-center" src="<?php echo htmlentities(cdnurl($row['goods']['image'])); ?>"></a></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['title']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['comment']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['praise']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['moderate']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['negative']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['like']; ?></td>			<td style="text-align: center; vertical-align: middle; "><?php echo $row['goods']['payment']; ?></td>			<td style="text-align: center; vertical-align: middle; ">				<a href="javascript:;" class="btn btn-xs btn-primary detail" data-toggle="tooltip" data-id="<?php echo $row['order_id']; ?>" data-original-title="查看訂單詳情"><i class="fa fa-eye"></i> 訂單詳情</a>			</td>		</tr>	</tbody></table><p><i class="fa fa-pencil-square-o"></i> 評論詳情</p><table class="table table-striped">	<tr>		<td style="width: 30%;"><?php echo __('用戶'); ?></td>		<td><?php echo $row['user']['nickname']; ?></td>	</tr>	<tr>		<td><?php echo __('评价'); ?></td>		<td>			<?php switch($row['state']): case "0": ?><span class="label label-info">好評</span><?php break; case "1": ?><span class="label label-warning">中評</span><?php break; case "2": ?><span class="label label-primary">差評</span><?php break; endswitch; ?>		</td>	</tr>	<tr>		<td><?php echo __('評論內容'); ?></td>		<td><?php echo $row['content']; ?></td>	</tr>	<?php if(!(empty($row['images']) || (($row['images'] instanceof \think\Collection || $row['images'] instanceof \think\Paginator ) && $row['images']->isEmpty()))): ?>	<tr>		<td><?php echo __('Images'); ?></td>		<td>			<?php if(is_array($row['images']) || $row['images'] instanceof \think\Collection || $row['images'] instanceof \think\Paginator): $i = 0; $__LIST__ = $row['images'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>				<img class="img-sm img-center" src="<?php echo htmlentities(cdnurl($vo)); ?>">			<?php endforeach; endif; else: echo "" ;endif; ?>		</td>	</tr>	<?php endif; ?>	<tr>		<td><?php echo __('Score'); ?></td>		<td>			<div class="star-rating">				<div class="star-rating-top" style="width:<?php echo $row['score']*2*10; ?>%">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>				<div class="star-rating-bottom">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>			</div>		</td>	</tr>	<tr>		<td><?php echo __('Score_describe'); ?></td>		<td>			<div class="star-rating">				<div class="star-rating-top" style="width:<?php echo $row['score_describe']*2*10; ?>%">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>				<div class="star-rating-bottom">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>			</div>		</td>	</tr>	<tr>		<td><?php echo __('Score_service'); ?></td>		<td>			<div class="star-rating">				<div class="star-rating-top" style="width:<?php echo $row['score_service']*2*10; ?>%">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>				<div class="star-rating-bottom">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>			</div>		</td>	</tr>	<tr>		<td><?php echo __('Score_deliver'); ?></td>		<td>			<div class="star-rating">				<div class="star-rating-top" style="width:<?php echo $row['score_deliver']*2*10; ?>%">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>				<div class="star-rating-bottom">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>			</div>		</td>	</tr>	<tr>		<td><?php echo __('Score_logistics'); ?></td>		<td>			<div class="star-rating">				<div class="star-rating-top" style="width:<?php echo $row['score_logistics']*2*10; ?>%">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>				<div class="star-rating-bottom">					<i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>				</div>			</div>		</td>	</tr>	</table>
