<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/page/link.html";i:1608355014;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<html lang="<?php echo $config['language']; ?>">
    ...
    <div class="panel-heading">
        <ul class="nav nav-tabs" data-field="sort">
            <li class="active"><a href="#t-all" data-value="" data-toggle="tab"><?php echo __('All'); ?></a></li>
            <?php if(is_array($sortList) || $sortList instanceof \think\Collection || $sortList instanceof \think\Paginator): if( count($sortList)==0 ) : echo "" ;else: foreach($sortList as $key=>$vo): ?>
