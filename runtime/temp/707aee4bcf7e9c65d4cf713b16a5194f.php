<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/page/recyclebin.html";i:1626755514;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<html lang="<?php echo $config['language']; ?>">
	...
	<div class="panel-heading"><div class="panel-lead"><em>履歴ページ</em>再度有効にする場合は、エディターに移動して再編集してください</div></div>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a class="btn btn-danger btn-multi btn-disabled disabled" href="javascript:;" data-url="wanlshop/page/destroy" data-action="destroy"><i class="fa fa-times"></i> <?php echo __('Destroy'); ?></a>
                        <a class="btn btn-danger btn-destroyall" href="javascript:;" data-url="wanlshop/page/destroy" title="<?php echo __('Destroy all'); ?>"><i class="fa fa-times"></i> <?php echo __('Destroy all'); ?></a>
                    </div>
                    <table id="table" class="table table-striped table-bordered table-hover" data-operate-destroy="wanlshop/page/destroy" width="100%">
                    </table>
                </div>
            </div>
