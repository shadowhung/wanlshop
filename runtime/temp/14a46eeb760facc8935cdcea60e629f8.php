<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/user/changepwd2.html";i:1654875654;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1654875636;s:71:"/www/wwwroot/www.fdadeal.com/application/index/view/common/sidenav.html";i:1613938418;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h2 class="page-header"><?php echo __('Change password2'); ?></h2>
                    <form id="changepwd-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
                        <?php echo token(); ?>
                        <div class="form-group">
                            <label for="oldpassword" class="control-label col-xs-12 col-sm-4"><?php echo __('Old password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" maxlength="6" onkeyup="value=value.replace(/[^\d\.]/g,'')"  class="form-control" id="oldpassword" name="oldpassword" value="" placeholder="<?php echo __('Old password2'); ?>">
                                <span style="color:red;">(If not set, leave it blank)</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="newpassword" class="control-label col-xs-12 col-sm-4"><?php echo __('New password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" maxlength="6" onkeyup="value=value.replace(/[^\d\.]/g,'')"  class="form-control" id="newpassword" name="newpassword" value="" data-rule="required" placeholder="<?php echo __('New password2'); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="renewpassword" class="control-label col-xs-12 col-sm-4"><?php echo __('Renew password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                <input type="text" maxlength="6" onkeyup="value=value.replace(/[^\d\.]/g,'')"  class="form-control" id="renewpassword" name="renewpassword" value="" data-rule="required" placeholder="<?php echo __('Renew password2'); ?>" />
                            </div>
                        </div>
