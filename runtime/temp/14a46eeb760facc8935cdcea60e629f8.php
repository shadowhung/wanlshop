<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/user/changepwd2.html";i:1626755826;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;s:71:"/www/wwwroot/www.fdadeal.com/application/index/view/common/sidenav.html";i:1613938418;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="panel-body">
                    ...
                    <form id="changepwd-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
                        ...
                        <div class="form-group">
                            <label for="oldpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('Old password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                                ...
                                <span style="color:red;">(設定されていません。空白のままにしてください)</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="newpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('New password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
                        ...
                        <div class="form-group">
                            <label for="renewpassword" class="control-label col-xs-12 col-sm-2"><?php echo __('Renew password2'); ?>:</label>
                            <div class="col-xs-12 col-sm-4">
