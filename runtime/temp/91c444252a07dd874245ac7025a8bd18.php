<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/shop/invitation.html";i:1637326715;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="panel-body">
                    ...
                    <div class="row user-baseinfo">
                        <div class="col-md-9 col-sm-9 col-xs-12">
                         <h3>あなたのユニークな招待コードは：</h3>
                         <h2><?php echo $user['verifycode']; ?></h2>
                         <h3>促す：Manya 売り手システムは、落ち着くための招待システムです。落ち着くために友人を招待すると、店の重量を増やすのに役立ちます</h3>
                        </div>
                    </div>
                </div>
            </div>
