<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/goods/edit.html";i:1632437150;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8">
													...
													<input id="c-title" data-rule="required" class="form-control" name="row[title]" type="text" placeholder="製品タイトルを入力してください" value="<?php echo htmlentities($row['title']); ?>">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8">
													...
													<input id="c-brand" data-rule="required" class="form-control" name="row[brand]" type="text" placeholder="製品タイトルを入力してください" value="<?php echo htmlentities($row['brand']); ?>">
											...
											<!--<div class="form-group">
											    ...
											    <div class="col-xs-12 col-sm-8">
													...
													<div class="input-group">
														...
														type="text" placeholder="點擊選擇商品品牌" value="<?php echo htmlentities($row['brand_id']); ?>">
