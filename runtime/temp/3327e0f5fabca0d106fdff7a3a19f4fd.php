<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/coupon/index.html";i:1654875680;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1654875636;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a class="btn btn-success btn-recyclebin btn-dialog" href="wanlshop/coupon/recyclebin" title="<?php echo __('Recycle bin'); ?>"><i class="fa fa-recycle"></i> <?php echo __('Recycle bin'); ?></a>
                    </div>
