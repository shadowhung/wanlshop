<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/shopsort/edit.html";i:1654745616;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<html lang="<?php echo $config['language']; ?>">
    ...
    <div class="form-group">
        <label for="pid" class="control-label col-xs-12 col-sm-2"><?php echo __('Pid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <select name="row[pid]" data-rule="required" id="pid" class="form-control">
                ...
                <option value="<?php echo $vo['id']; ?>"  <?php if($vo['id']==$row['pid']): ?> selected<?php endif; ?>><?php echo $vo['name']; ?></option>
