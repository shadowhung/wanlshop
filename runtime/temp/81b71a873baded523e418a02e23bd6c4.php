<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/config/index.html";i:1626748128;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<div class="alert alert-success-light">
	...
	<i class="fa fa-warning"></i> 注意：1。ウェルカムメッセージを空白のままにして、有効になっていないことを示します。デフォルトではチャットメッセージは送信されません。
...
<div class="panel panel-default panel-intro">
	...
	<div class="panel-heading">
		...
		<ul class="nav nav-tabs">
			...
			<li <?php if(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty())): if($key == 'freight'): ?>class="active"<?php endif; else: if($type == $key): ?>class="active"<?php endif; endif; ?>> <a href="#<?php echo $key; ?>" data-toggle="tab"><?php echo $vo; ?></a></li>
	...
	<div class="panel-body">
		...
		<div id="myTabContent" class="tab-content">
			...
			<div class="tab-pane fade <?php if(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty())): ?> active in <?php else: if($type == 'freight'): ?>active in<?php endif; endif; ?>" id="freight">

				<div class="widget-body no-padding">

					<form id="freight-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('wanlshop.config/index'); ?>">
						...
						<table class="table table-striped">
							...
							<thead>
								...
								<tr>
									...
									<th width="120px"><?php echo __('Title'); ?></th>
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<?php echo Form::radios('row[freight]', ['0'=>'運費疊加', '1'=>'以最低結算', '2'=>'以最高結算'], $row['freight'], ['data-rule'=>'required']); ?>
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<textarea name="row[welcome]" class="form-control" rows="5" data-tip="空、ウェルカムメッセージが使用されていないことを意味します"><?php echo htmlentities($row['welcome']); ?></textarea>
			...
			<div class="tab-pane fade <?php if(!(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty()))): if($type == 'kuaidi'): ?>active in<?php endif; endif; ?>" id="kuaidi">

				<div class="widget-body no-padding">

					<form id="kuaidi-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('wanlshop.config/index'); ?>">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<?php echo Form::switcher('row[iscloud]', $row['iscloud'], ['color'=>'success', 'yes'=>'1', 'no'=>'0']); ?>
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<?php echo Form::switcher('row[isauto]', $row['isauto'], ['color'=>'success', 'yes'=>'1', 'no'=>'0']); ?>
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[secret]" value="<?php echo htmlentities($row['secret']); ?>" class="form-control" data-rule="" data-tip="Express100シークレットパラメータ">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[key]" value="<?php echo htmlentities($row['key']); ?>" class="form-control" data-rule="" data-tip="Express100の許可されたKEYパラメーター">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[partnerId]" value="<?php echo htmlentities($row['partnerId']); ?>" class="form-control" data-rule="" data-tip="宅配会社の電子請求書アカウントまたは月次アカウント">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[partnerKey]" value="<?php echo htmlentities($row['partnerKey']); ?>" class="form-control" data-rule="" data-tip="宅配会社によって割り当てられた電子対面パスワード">
			...
			<div class="tab-pane fade <?php if(!(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty()))): if($type == 'facesheet'): ?>active in<?php endif; endif; ?>" id="facesheet">

				<div class="widget-body no-padding">

					<form id="facesheet-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('wanlshop.config/edit'); ?>">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[siid]" value="<?php echo htmlentities($row['siid']); ?>" class="form-control" data-rule="required" data-tip="ACMD893784">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[tempid]" value="<?php echo htmlentities($row['tempid']); ?>" class="form-control" data-rule="required" data-tip="といった：ad8470013eb64c979120ca75c6bf7bae">
			...
			<div class="tab-pane fade <?php if(!(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty()))): if($type == 'mailing'): ?>active in<?php endif; endif; ?>" id="mailing">

				<div class="widget-body no-padding">

					<form id="mailing-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('wanlshop.config/index'); ?>">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[sendName]" value="<?php echo htmlentities($row['sendName']); ?>" class="form-control" data-tip="張三丰" data-rule="required">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="number" name="row[sendPhoneNum]" value="<?php echo htmlentities($row['sendPhoneNum']); ?>" class="form-control" data-tip="" data-rule="required">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<textarea name="row[sendAddr]" class="form-control" rows="5" data-tip="" data-rule="required"><?php echo htmlentities($row['sendAddr']); ?></textarea>
			...
			<div class="tab-pane fade <?php if(!(empty($type) || (($type instanceof \think\Collection || $type instanceof \think\Paginator ) && $type->isEmpty()))): if($type == 'return'): ?>active in<?php endif; endif; ?>" id="return">

				<div class="widget-body no-padding">

					<form id="return-form" class="edit-form form-horizontal" role="form" data-toggle="validator" method="POST" action="<?php echo url('wanlshop.config/index'); ?>">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="text" name="row[returnName]" value="<?php echo htmlentities($row['returnName']); ?>" class="form-control" data-tip="張三丰" data-rule="required">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<input type="number" name="row[returnPhoneNum]" value="<?php echo htmlentities($row['returnPhoneNum']); ?>" class="form-control" data-tip="固定電話または携帯電話番号を入力してください" data-rule="required">
									...
									<td>
										...
										<div class="row">
											...
											<div class="col-sm-8 col-xs-12">
												...
												<textarea name="row[returnAddr]" class="form-control" rows="5" data-tip="" data-rule="required"><?php echo htmlentities($row['returnAddr']); ?></textarea>
