<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/brand/add.html";i:1654745639;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<html lang="<?php echo $config['language']; ?>">
	...
	重要なヒント：
	<p>1.申請後、プラットフォーム監査を待つ必要があり、ブランドを間に合わせることができません。>ストア管理>ブランド管理で審査ステータスを確認してください。</p>

    <p>2.カテゴリには最後のレベルのみを選択でき、親レベルは表示されません</p>
	...
	<div class="form-group">
	    ...
	    <div class="col-xs-12 col-sm-8">
			...
			<select name="row[category_id]" class="form-control" id="category_id">
