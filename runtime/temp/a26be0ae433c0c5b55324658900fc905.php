...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-isshua" class="control-label col-xs-12 col-sm-2">是否是刷单账号:</label>
        <div class="col-xs-12 col-sm-8">
            <?php echo build_radios('row[isshua]', ['1'=>'是', '0'=>'否'], $row['isshua']); ?>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="c-paypass" class="control-label col-xs-12 col-sm-2">支付密码:</label>
        <div class="col-xs-12 col-sm-4">
            <input id="c-paypass" data-rule="" class="form-control" name="row[paypass]" maxlength="6" onkeyup="value=value.replace(/[^\d\.]/g,'')" value="" placeholder="不修改支付密码请留空" autocomplete="new-paypass" />
        </div>
    </div>
    <div class="form-group">
