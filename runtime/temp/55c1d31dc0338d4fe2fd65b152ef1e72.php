<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/order/relative.html";i:1626753632;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<div class="wanl_kuaidi">
	<table class="">
		<thead>
            ...
            <tr>
    	    <th style="text-align: center;padding-left: 14px;">宅配会社：</th>
            <th style="text-align: center;padding-left: 14px;"><?php echo isset($data['name'])?$data['name']:'';?></th>
            </tr>
            <tr>
    	    <th style="text-align: center;padding-left: 14px;">追跡番号：</th>
		    ...
		    <tr>
		      ...
		      <th style="text-align: center;padding-left: 14px;">時間</th>
		...
		<?php switch($row['state']): case "1": ?>
			...
			<?php break; default: if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
				<tr>
					<td class="status">
						<span class="day"><?php echo date("Y.m.d",$row['delivertime']); ?></span>
						<span class="time"><?php echo date("H:i",$row['delivertime']); ?></span>
						<span class="week"></span>
					</td>
					<td class="process">
						<i class="fa fa-truck"></i>
					</td>
					<td class="info"><span>図書館から出るには</span>メーカーは在庫があり、24時間以内に発送される予定です。
					...
					?>
                    <?php echo date("Y.m.d",$row['delivertime']+$time2); ?>納品されましたので、しばらくお待ちください。~</td>
					<!---包裹正在等待快遞小哥攬收-->
				</tr>
				
				<?php if(!isset($data['name'])){ $time1 = date('H',$row['delivertime']);
