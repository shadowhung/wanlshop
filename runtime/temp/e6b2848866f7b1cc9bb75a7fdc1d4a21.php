<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/attachment/index.html";i:1654875684;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1654875636;}*/ ?>
<!DOCTYPE html>
								...
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
										...
										<div class="content">
											...
											<div class="panel panel-default panel-intro">		<div class="panel-heading">		<div class="panel-lead"><em>Storage space </em>Mainly used for product main image and photo album and photo album image storage service (total <?php echo $picCount; ?> files, usage: <?php echo $picSum; ?>)</div>	    <ul class="nav nav-tabs" data-field="mimetype">	        <li class="active"><a href="#t-all" data-value="" data-toggle="tab"><?php echo __('All'); ?></a></li>	        <?php if(is_array($mimetypeList) || $mimetypeList instanceof \think\Collection || $mimetypeList instanceof \think\Paginator): if( count($mimetypeList)==0 ) : echo "" ;else: foreach($mimetypeList as $key=>$vo): ?>	        <li><a href="#t-<?php echo $key; ?>" data-value="<?php echo $key; ?>" data-toggle="tab"><?php echo $vo; ?></a></li>	        <?php endforeach; endif; else: echo "" ;endif; ?>	    </ul>	</div>    <div class="panel-body">        <div id="myTabContent" class="tab-content">            <div class="tab-pane fade active in" id="one">                <div class="widget-body no-padding">                    <div id="toolbar" class="toolbar">						<a href="javascript:;" class="btn btn-primary btn-refresh" title="重繪"><i class="fa fa-refresh"></i> </a>						<span><button type="button" id="plupload-image" class="btn btn-success plupload" data-mimetype="<?php echo (\think\Request::instance()->get('mimetype') ?: ''); ?>" data-multiple="true"><i class="fa fa-upload"></i> <?php echo __('Upload file'); ?></button></span>						<a href="javascript:;" class="btn btn-danger btn-del btn-disabled disabled" title="删除"><i class="fa fa-trash"></i> <?php echo __('Delete'); ?></a>                    </div>                    <table id="table" class="table table-striped table-bordered table-hover" width="100%"> </table>                </div>            </div>        </div>    </div></div>
