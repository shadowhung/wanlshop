<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/wholesale/edit.html";i:1635786006;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
										...
										<div class="panel-body">
											...
											<div class="form-group">
												...
												<div class="col-xs-12 col-sm-8">
													...
													<input id="c-title" readonly="readonly" data-rule="required" class="form-control" name="row[title]" type="text" placeholder="製品タイトルを入力してください" value="<?php echo htmlentities($row['title']); ?>">
											...
											<div class="form-group">
											    ...
											    <div class="col-xs-12 col-sm-8">
													...
													<div class="input-group">
														...
														type="text" placeholder="クリックして製品ブランドを選択" value="<?php echo htmlentities($row['brand_id']); ?>">
							...
							<div class="row" id="sale">
								...
								<div class="col-md-12">
									...
									<div class="panel panel-default">
										...
										<div class="panel-heading">販売情報</div>

										<div class="panel-body">

											<div class="form-group wanl-specs">

												<label class="control-label col-xs-12 col-sm-2"><?php echo __('製品の内容'); ?>:</label>
									...
									<div class="panel-body">
												...
												<div class="input-group">
												    ...
												    <ul class="row list-inline plupload-preview" id="p-image">
												        <li class="col-xs-12" style="width: 110px;">
												            ...
												            <img onclick="previewImg(this)" src="https://imagesrb.oss-ap-northeast-1.aliyuncs.com<?php echo htmlentities($row['image']); ?>" onerror="this.src='/index/ajax/icon?suffix=jpg';this.onerror=null;" class="img-responsive">
												            </a>
												        </li>
												    </ul>
												...
												<div class="input-group">
												    ...
												    <ul class="row list-inline plupload-preview" id="p-images">
												        <?php if(is_array($row['images']) || $row['images'] instanceof \think\Collection || $row['images'] instanceof \think\Paginator): if( count($row['images'])==0 ) : echo "" ;else: foreach($row['images'] as $key=>$vo): ?>
												            <li class="col-xs-12" style="width: 110px;">
    												            <a href="javascript:" data-url="javascript:" class="thumbnail">
    												            <img onclick="previewImg(this)" src="https://imagesrb.oss-ap-northeast-1.aliyuncs.com<?php echo htmlentities($vo); ?>" onerror="this.src='/index/ajax/icon?suffix=jpg';this.onerror=null;" class="img-responsive">
    												            </a>
    												        </li>
										...
										<div class="form-group">
										    ...
										    <div class="col-xs-12 col-sm-8">
												...
												<input readonly="readonly" id="c-description" data-rule="required" class="form-control" name="row[description]" type="text" value="<?php echo htmlentities($row['description']); ?>">
										...
										<div class="form-group">
											...
											<div class="col-xs-12 col-sm-8">
												...
												<textarea readonly="readonly" id="c-content" data-rule="required" class="form-control editor" rows="5" name="row[content]" cols="50"><?php echo htmlentities($row['content']); ?></textarea>
