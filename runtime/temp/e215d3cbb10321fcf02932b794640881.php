<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/refund/refuse.html";i:1608355016;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Refuse_content'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
			<?php echo Form::textarea('row[refuse_content]', '', ['data-rule'=>'required']); ?>
        </div>
    </div>
