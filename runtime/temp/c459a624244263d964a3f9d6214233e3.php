<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/www/wwwroot/www.fdadeal.com/public/../application/index/view/wanlshop/shopsort/index.html";i:1626755718;s:72:"/www/wwwroot/www.fdadeal.com/application/index/view/layout/wanlshop.html";i:1636510733;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
						...
						<a href="javascript:;" class="btn btn-danger btn-toggle-all"><i class="fa fa-plus"></i> <?php echo __('リストを展開する'); ?></a>
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover table-nowrap"
                           data-operate-edit="wanlshop/shopsort/edit" 
                           data-operate-del="wanlshop/shopsort/del" 
                           width="100%">
                    </table>
                </div>
            </div>
