...
if(!/iphone|ipad|ipod/.test(ua)){
    if(document.getElementById('iosiframe')){
       document.getElementById('iosiframe').setAttribute('scrolling','auto');
    }
}else{
    console.log(document.getElementById('iosiframe'));
    if(document.getElementById('iosiframe')){
       document.getElementById('iosiframe').style.width = screenwidth + 'px';  
    }
}
