    ...
    var o = {
            ...
            new i({
                ...
                methods: {
                    ...
                    categoryLink: function() {
                        var e = this;
                        parent.Fast.api.open("wanlshop/shopsort/select?multiple=true", __("カテゴリリンクを選択してください"), {
                            area: ["800px", "600px"],
                            callback: function(t) {
                                e.range = t.url
                            }
                    ...
                    goodsLink: function() {
                        var e = this;
                        parent.Fast.api.open("wanlshop/goods/select?multiple=true", __("製品リンクを選択してください"), {
                            area: ["800px", "600px"],
                            callback: function(t) {
                                e.range = t.url
                            }
        ...
        api: {
            formatter: {
                mode: function(e, t, a) {
                    var r = "";
                    return ("reduction" == t.type || "vip" == t.type && "reduction" == t.usertype) && (r = "<span>滿 " + Number(t.limit) + " 円減" + Number(t.price) + "</span>"),
                    ("discount" == t.type || "vip" == t.type && "discount" == t.usertype) && (r = '<span class="text-success">滿 ' + Number(t.limit) + " 円打" + Number(t.discount) + "折</span>"),
                    "shipping" == t.type && (r = '<span class="text-danger">滿 ' + Number(t.limit) + " 円船</span>"),
                    r
                },
                invalid: function(e, t, a) {
                    return 0 == e ? "fixed" == t.pretype && new Date(t.startdate).getTime() > (new Date).getTime() ? '<span class="text-primary"><i class="fa fa-circle"></i> まだ始まっていない</span>': '<span class="text-success"><i class="fa fa-circle"></i> 分布</span>': 1 == e ? '<span class="text-danger"><i class="fa fa-circle"></i> 期限切れ</span>': void 0
                },
                ...
                overdue: function(e, t, a) {
                    return "fixed" == t.pretype ? t.enddate: 0 == t.validity ? "長期有効": "受け取る " + t.validity + " 天"
                },
