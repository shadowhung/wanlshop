define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'clockin/signin/index' + location.search,
                    add_url: 'clockin/signin/add',
                    edit_url: 'clockin/signin/edit',
                    del_url: 'clockin/signin/del',
                    multi_url: 'clockin/signin/multi',
                    table: 'signin',
                }
            });
