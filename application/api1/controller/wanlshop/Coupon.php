...

{
...

	{
		...
		$list = model('app\api1\model\wanlshop\Coupon')
...

	{
		...
		$list = model('app\api1\model\wanlshop\CouponReceive')
...

	{
		...
		if ($this->request->isPost()) {
			...
			$coupon = model('app\api1\model\wanlshop\Coupon')->get($id);
			...
			$myCouponCount = model('app\api1\model\wanlshop\CouponReceive')
			...
			$result = model('app\api1\model\wanlshop\CouponReceive');
...

	{
		...
		$coupon = model('app\api1\model\wanlshop\CouponReceive')->get($id);
